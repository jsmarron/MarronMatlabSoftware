disp('Running MATLAB script file DiProPermSMtest.m') ;
%
%    FOR DEVELOPMENT AND TESTING OF MATLAB FUNCTION DiProPermSM,
...
itest = 74 ;     %  1,...,74  Simple parameter tests
...
if itest < 100 ;    %  then do simple parameter tests, on small data set
  ...
  elseif itest == 2 ;    % try titles
    ...
    DiProPermSM(data1,data2,paramstruct) ;
  ...
  elseif itest == 15 ;    %  run twice, check different numerical answers
    ...
    paramstruct = struct('nsim',50, ...
                         ...
                         'ishowperm',0, ...
                         'iscreenwrite',1) ;
    [stat,pval,zscore] = DiProPermSM(data1,data2,paramstruct) 
  ...
  elseif itest == 41 ;    % test unbalanced design
    ...
    paramstruct = struct('ipval',1, ...
                         ...
                         'iscreenwrite',1) ;
    DiProPermSM(data1,data2(:,1:5),paramstruct) ;
  ...
  elseif itest == 43 ;    % test unequal data dimensions
    ...
    paramstruct = struct('ipval',1, ...
                         ...
                         'iscreenwrite',1) ;
    DiProPermSM(data1,data2(1:20,:),paramstruct) ;
  ...
  elseif itest == 65 ;    % test Paired t stat, paired data
    ...
    paramstruct = struct('mctl',[[1 6]; [1 1]], ...
                         ...
                         'iscreenwrite',1) ;
    DiProPermSM(data1s,data2s,paramstruct) ;
  ...
  elseif itest == 67 ;    % test Paired t stat, differing n1 & n2
    ...
    paramstruct = struct('istat',6, ...
                         ...
                         'iscreenwrite',1) ;
    DiProPermSM(data1,data2(:,1:(end - 1)),paramstruct) ;
    ...
    for idataset = 1:ndataset ;
      ...
      for mean = vmean ;
        ...
        paramstruct = struct('mctl',[[idir 1]; [idir 2]], ...
                             ...
                             'nreport',100, ...
                             'iscreenwrite',1) ;
        [vstat, vpval, vzscore] = DiProPermSM(data1,data2,paramstruct) ;
