disp('Running MATLAB script file MeanHypoTestHDLSSSMtest.m') ;
%
...
itest = 31 ;      %  1  Full scale test with toy data (everything at defaults)
                  %  2,...,31  parameter tests
...
if itest == 1 ;
  ...
  MeanHypoTestHDLSSSM(mtraindat1,mtraindat2) ;
...
elseif itest == 2 ;
  ...
  MeanHypoTestHDLSSSM(mtraindat1,mtraindat2,paramstruct) ;
...
elseif itest == 28 ;
  ...
  paramstruct = struct('nsim',10, ...
                       ...
                       'title2str','Look for MeanHypoTestHDLSSSM.ps', ...
                       'iscreenwrite',1) ;
...
elseif itest == 29 ;
  ...
  pval = MeanHypoTestHDLSSSM(mtraindat1,mtraindat2,paramstruct) ;
...
elseif itest == 30 ;
  ...
  [pval,tstat] = MeanHypoTestHDLSSSM(mtraindat1,mtraindat2,paramstruct) ;
