function  [veigvest, tau] = SigClustCovEstHH(vsampeigv,sig2b) 
% SIGCLUSTCOVESTHH, statistical SIGnificance of CLUSTers,
...
%    Copyright (c) J. S. Marron & Hanwen Huang 2008, 2014, 2023
...
if size(vsampeigv,2) > 1 
  ...
  tau = [] ;
  disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!') ;
  disp('!!!   Error from SigClustCovEstHH:        !!!') ;
...
if vtaucand(end) >= 0    %  if all of these are positive
  ...
  disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!') ;
  disp('!!!   Warning from SigClustCovEstHH:           !!!') ;
