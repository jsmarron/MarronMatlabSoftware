...
[mpcprobes,msmoothprobes,indexstruct] = NearlyNullSpaceBasisSM(G,ivx,nullnum,inpcplot,insmoothplot) ;
  ...
  vpceigval = indexstruct.vpceigval ;
  vsmootheigval = indexstruct.vsmootheigval ;
  vpcsmooth = indexstruct.vpcsmooth ;
  vsmoothsmooth = indexstruct.vsmoothsmooth ;
  vallsmosmooth = indexstruct.vallsmosmooth ;
