...
%                                Caution: when all entries of data are the same,
%                                             any of the above give a warning 
%                                             message, and uses a bandwidth
%                                             of 1/4 the input range
...
%                            Caution: when all entries of data are the same,
%                                         both of the above give a warning 
%                                         message, and an empty return
...
if  imptyp > -0.5  &&  ...
  ...
  if length(vxgrid) < 1.5     %  No indication given for length of output,
    ...
    disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!') ;
    disp('!!!   Error from kdeSM.m:            !!!') ;
    disp('!!!   All Data Numbers are Same      !!!') ;
    disp('!!!   And No Range is Given          !!!') ;
    disp('!!!   Returning Empty Results        !!!') ;
    disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!') ;
    kde = [] ;
    xgrid = [] ;
    mker = [] ;
    ...
    if vh <= 0     %  Automatic bandwidth was requested
      ...
      disp('!!!   Warning from kdeSM.m:               !!!') ;
      disp('!!!   All Data Numbers are Same           !!!') ;
      disp('!!!   And Automatic Bandwidth Requested   !!!') ;
      disp('!!!   Instead Using 1/4 of the Range      !!!') ;
      disp('!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!') ;
