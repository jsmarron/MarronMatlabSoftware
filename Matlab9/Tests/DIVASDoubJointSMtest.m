...
itest = 32 ;     %  1,...,32        Simple parameter tests
...
%  mY2 = 0.8 * u3 * v3' ;
  ...
  elseif itest == 20
    disp('test nThreshSim = 0, manual vthresh [200, 200, 200]') ;
        %  recommend running this right after itest = 4
        %  to see baseline of crude Marcenko-Pastur
    paramstruct = struct('nThreshSim',0, ...
                         'vthresh',[200 200 200], ...
                         'iscreenwrite',1) ;
    outstruct = DIVASDoubJointSM(mX,mY,paramstruct)
  ...
  elseif itest == 21
    disp('test nThreshSim = 0, manual vthresh [1000, 200, 200]') ;
        %  recommend running this right after itest = 20
        %  to see baseline of crude Marcenko-Pastur
    paramstruct = struct('nThreshSim',0, ...
                         'vthresh',[1000 200 200], ...
                         'iscreenwrite',1) ;
    outstruct = DIVASDoubJointSM(mX,mY,paramstruct)

  elseif itest == 22
    disp('test nThreshSim = 0, manual vthresh [1000, 1200, 200]') ;
        %  recommend running this right after itest = 21
        %  to see baseline of crude Marcenko-Pastur
    paramstruct = struct('nThreshSim',0, ...
                         'vthresh',[1000 1200 200], ...
                         'iscreenwrite',1) ;
    outstruct = DIVASDoubJointSM(mX,mY,paramstruct)

  elseif itest == 23
    disp('test nThreshSim = 0, manual vthresh [200, 1200, 200]') ;
        %  recommend running this right after itest = 22
        %  to see baseline of crude Marcenko-Pastur
    paramstruct = struct('nThreshSim',0, ...
                         'vthresh',[200 1200 200], ...
                         'iscreenwrite',1) ;
    outstruct = DIVASDoubJointSM(mX,mY,paramstruct)

  elseif itest == 24
    disp('test nThreshSim = 0, manual vthresh [200, 200, 1200]') ;
        %  recommend running this right after itest = 23
        %  to see baseline of crude Marcenko-Pastur
    paramstruct = struct('nThreshSim',0, ...
                         'vthresh',[200 200 1200], ...
                         'iscreenwrite',1) ;
    outstruct = DIVASDoubJointSM(mX,mY,paramstruct)

  elseif itest == 25
    disp('test nThreshSim = 0, manual vthresh [200, 1200, 1200]') ;
        %  recommend running this right after itest = 24
        %  to see baseline of crude Marcenko-Pastur
    paramstruct = struct('nThreshSim',0, ...
                         'vthresh',[200 1200 1200], ...
                         'iscreenwrite',1) ;
    outstruct = DIVASDoubJointSM(mX,mY,paramstruct)

  elseif itest == 26
    disp('test nThreshSim = 0, manual vthresh [2000, 200, 200]') ;
        %  recommend running this right after itest = 24
        %  to see baseline of crude Marcenko-Pastur
    paramstruct = struct('nThreshSim',0, ...
  ...
  elseif itest == 32
    disp('test imptype = 3, Tensor decoposition') ;
    paramstruct = struct('imptype',3, ...
                         'nThreshSim',0, ...
                         'iscreenwrite',1) ;
    outstruct = DIVASDoubJointSM(mX,mY,paramstruct)
    disp('test imptype = 3, Tensor decomposition') ;
