...
%        This version developed by Xi Yang and Steve Marron, to include
...
itest = 1 ;     %  1,...,75  Simple parameter tests from DiProPermSMtest.m
                  ...
                  %  201,...,237 More tests of newer features
...
if itest < 100 ;    %  then do simple parameter tests, on small data set
  ...
  elseif itest == 2 ;    % try titles
    ...
    disp('Reduce nsim to 50, to limit waiting time') ;
  ...
  elseif itest == 3 ;    % try smaller nsim, for faster turnaround
    ...
    paramstruct = struct('nsim',50, ...
                         'title1str','Test Left Hand Title', ...
  ...
  elseif itest == 9 ;    % try out all pvalues
    ...
    paramstruct = struct('ipval',1, ...
                         'nsim',50, ...
                         'title1str','ipval = 1, all p-value info') ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 32 ;    %  test savestr, full color
    ...
    paramstruct = struct('nsim',50, ...
                         ...
                         'title2str','look for file temp.fig', ...
                         'savestr','temp', ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 34 ;    %  test savestr, color
    ...
    paramstruct = struct('nsim',50, ...
                         'nreport',25, ...
                         'icolor',1, ...
                         'title1str','test savestr, icolor = 1', ...
                         'title2str','look for file temp.fig', ...
                         'savestr','temp', ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 35 ;    %  test savestr, color, input colors
    ...
    paramstruct = struct('nsim',50, ...
                         'nreport',25, ...
                         'icolor',icolor, ...
                         'title1str','test savestr, input color', ...
                         'title2str','look for file temp.fig', ...
                         'savestr','temp', ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
...
%}
  ...
  elseif itest < 120 ;    %  explore Gaussian mean differences
    ...
    d = 50 ;
    n = 20 ;
    vmean = [0 0.2 0.5 1 2 5 10 20 50 100] ;
    ...
    axisM(vmean',mzscoret) ;
      ...
      ylabel('Gaussian Fit PDC') ;
      orient landscape ;
      printSM([savestrbase '-t']) ;

    figure(2) ;
    clf ;
    plot(vmean',mzscoremd) ;    
    axisM(vmean',mzscoremd) ;
      hold on ;
        plot([0; max(vmean)], [norminv(1 - 0.05); norminv(1 - 0.05)], 'r--') ;
        plot([0; max(vmean)], [norminv(1 - 0.001); norminv(1 - 0.001)], 'r--') ;
      hold off ;
  ...
  elseif itest == 205 ;    % DWDLarge, all permutations
  ...
  elseif itest == 224 ;    %  Check outputs pval and Zscore
    ...
    [stat, pval, PDC] = DiProPermXY(data1,data2,paramstruct) ;

    disp(['pval = ' num2str(pval)]) ;
    disp(['PDC = ' num2str(PDC)]) ;
  ...
  elseif itest == 229 ;    %  Check idir = 7,  reparametrized DWD Large
                           %  Strong Signal Context of Xi Yang
    ...
    paramstruct = struct('idir',1, ...
                         ...
                         'ishowperm',2, ...
                         'nsim',50, ...
                         'title1str','DWD2, Strong Signal, all') ;
    DiProPermXY(data1,data2,paramstruct) ;
    ...
    paramstruct = struct('idir',7, ...
                         ...
                         'ishowperm',2, ...
                         'nsim',50, ...
                         'title1str','DWD Large, reparam, all') ;
    DiProPermXY(data1,data2,paramstruct) ;


  elseif itest == 230 ;    % Test print to .png

    disp('   Test save to .png') ;
    paramstruct = struct('nsim',50, ...
                         'title1str','savetype = 2, .png', ...
                         'title2str','Look for temp.png', ...
                         'savestr','temp', ...
                         'savetype',2, ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 231 ;    % Test print to .pdf

    disp('   Test save to .pdf') ;
    paramstruct = struct('nsim',50, ...
                         'title1str','savetype = 3, .pdf', ...
                         'title2str','Look for temp.pdf', ...
                         'savestr','temp', ...
                         'savetype',3, ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 232 ;    % Test print to .eps color

    disp('   Test save to .eps color') ;
    paramstruct = struct('nsim',50, ...
                         'title1str','savetype = 4, .eps color', ...
                         'title2str','Look for temp.eps', ...
                         'savestr','temp', ...
                         'savetype',4, ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 233 ;    % Test print to .eps B&W

    disp('   Test save to .eps B&W') ;
    paramstruct = struct('nsim',50, ...
                         'title1str','savetype = 5, .eps B&W', ...
                         'title2str','Look for temp.eps', ...
                         'savestr','temp', ...
                         'savetype',5, ...
                         'iscreenwrite',1) ;
  ...
  elseif itest == 234 ;    % Test print to .jpg

    disp('   Test save to .jpg') ;
    paramstruct = struct('nsim',50, ...
                         'title1str','savetype = 6, .jpg', ...
                         'title2str','Look for temp.jpg', ...
                         'savestr','temp', ...
                         'savetype',6, ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 235 ;    % Test print to .svc

    disp('   Test save to .svc') ;
    paramstruct = struct('nsim',50, ...
                         'title1str','savetype = 7, .svc', ...
                         'title2str','Look for temp.svc', ...
                         'savestr','temp', ...
                         'savetype',7, ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
  ...
  elseif itest == 236 ;    % Test bad iper

    paramstruct = struct('nsim',50, ...
                         'title1str','Test bad iper = 3', ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;


  elseif itest == 237 ;    % Test alpha

    figure(1) ;
    clf
    paramstruct = struct('nsim',50, ...
                         'title1str','Test default alpha', ...
                         'iscreenwrite',1) ;
    DiProPermXY(data1,data2,paramstruct) ;
