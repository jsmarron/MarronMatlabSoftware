...
itest = 34 ;     %  1,...,34  Simple parameter tests
...
if (itest == 1) | ...
   ...
   (itest == 32) | ...
   (itest == 33) | ...
   (itest == 34) ;     %  Simple parameter tests
  ...
  elseif itest == 27 ;
    ...
    HeatMapSM(mdata,paramstruct) ;
  elseif itest == 28 ;
    disp('  Test B&W savetype 2') ;
    savestr = 'HeatMapSMtestGray' ;
    paramstruct = struct('icolor',0, ...
                         'titlestr','Check for B&W .png', ...
                         'savestr',savestr, ...
                         'savetype',2) ;
    HeatMapSM(mdata,paramstruct) ;
  elseif itest == 29 ;
    disp('  Test Color savetype 2') ;
    disp('  Make color prints') ;
    savestr = 'HeatMapSMtestColor' ;
    paramstruct = struct('icolor',3, ...
                         'titlestr','Check for Color .png', ...
                         'savestr',savestr, ...
                         'savetype',2) ;
    HeatMapSM(mdata,paramstruct) ;
  elseif itest == 30 ;
    disp('  Test B&W savetype 3') ;
    savestr = 'HeatMapSMtestGray' ;
    paramstruct = struct('icolor',0, ...
                         'titlestr','Check for B&W .pdf', ...
                         'savestr',savestr, ...
                         'savetype',3) ;
    HeatMapSM(mdata,paramstruct) ;
  elseif itest == 31 ;
    disp('  Test Color savetype 3') ;
    disp('  Make color prints') ;
    savestr = 'HeatMapSMtestColor' ;
    paramstruct = struct('icolor',3, ...
                         'titlestr','Check for Color .pdf', ...
                         'savestr',savestr, ...
                         'savetype',3) ;
    HeatMapSM(mdata,paramstruct) ;
  elseif itest == 32 ;
    disp('  Test input color range') ;
    paramstruct = struct('icolor',0, ...
                         'alpha',[-3,3]') ;
    HeatMapSM(mdata,paramstruct) ;
  elseif itest == 33 ;
    ...
    HeatMapSM(mdata,paramstruct) ;
  elseif itest == 34 ;
    disp('  Test bad input color vector') ;
    paramstruct = struct('icolor',0, ...
                         'alpha',[-1,1,8]') ;
    HeatMapSM(mdata,paramstruct) ;
