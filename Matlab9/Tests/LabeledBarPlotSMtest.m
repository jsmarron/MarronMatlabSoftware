...
elseif itest == 21 ;    %  Test fontsize
  ...
  disp('    Look at file Temp.fig, and zoom in') ;
...
elseif itest == 35 ;    %  Test barcolor

  paramstruct = struct('isort',2, ...
                       'titlestr','Test input black barcolor', ...
                       'barcolor','k', ...
                       'savestr','Temp') ;
  nbar = 20 ;
  vhts = 1:nbar ;
...
elseif itest == 36 ;    %  Test barcolor

  paramstruct = struct('isort',2, ...
                       'titlestr','Test non-existent barcolor', ...
                       'barcolor','z', ...
                       'savestr','Temp') ;
  nbar = 20 ;
  vhts = 1:nbar ;
...
elseif itest == 37 ;    %  Test bad barcolor

  paramstruct = struct('isort',2, ...
                       'titlestr','Test bad input barcolor', ...
                       'barcolor',[0.7 0.7]) ;
  nbar = 20 ;
  vhts = 1:nbar ;
  vhts = vhts .* (-1).^mod(1:nbar,2) ;
