...
elseif itest == 2 ;    %  Then do real indat examples
  ...
  for idat = vidat ;
    ...
    if idat == 1 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\canearn' ;
      datatran = [] ;
    elseif idat == 2 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\lynx' ;
      datatran = ['data(:,2) = log10(data(:,2) + 1) ;' ...
                  'ystr = [''log10('' ystr '' + 1)''] ;'] ;
    elseif idat == 3 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\cars' ;
      datatran = [] ;
    elseif idat == 4 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\motodata' ;
      datatran = 'data = data(1:800,:) ;' ;
         %  First 800 are first trace
    elseif idat == 5 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\nicfoo' ;
      datatran = [] ;
    elseif idat == 6 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\phosphor' ;
      datatran = 'data(:,2) = log10(data(:,2)) ;' ;
    elseif idat == 7 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\sunspots' ;
      datatran = ['data(:,2) = sqrt(data(:,2)) ;' ...
                  'ystr = [''sqrt('' ystr '')''] ;'] ;
    elseif idat == 8 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\fossils' ;
      datatran = [] ;
    elseif idat == 9 ;
      matfilestr = 'C:\Users\marron\Documents\Research\GeneralData\sharyiel' ;
      datatran = [] ;
    end ;
...
elseif itest == 3 ;    %  Then do NR book examples
  ...
  if iset == 1 | iset == 0 ;
    ...
    fid = fopen('C:\Users\marron\Documents\Research\MatlabSoftware\gauss\steve\nrbook\nrdat1.dat','r') ;
...
elseif itest == 4 ;    %  Then do B-spline examples
  ...
  for ifile = 1:9 ;
    ...
    infstr = ['C:\Users\marron\Documents\Research\MatlabSoftware\gauss\steve\bspline\bs3' num2str(ifile) '.dat'] ;
    fid = fopen(infstr,'r') ;
      data = fscanf(fid,'%g %g %g',[3, inf]) ;
      data = data' ;
          %  since data rows are read in as columns
...
elseif itest == 10 ;     %  work with modified version for detailed output
  ...
  disp(['    Loading ' dtitstr ' Data']) ;
    infstr = ['C:\Users\marron\Documents\Research\GeneralData\' infstr] ;
load(infstr)
%    fid = fopen(infstr,'r') ;
