...
elseif itest == 2 ;
  ...
  disp(['Test icokor = 2, iplotaxes = 1, iplotdirvec = 1, savestr = ''temp'', iscreenwrite = 1, simple example']) ;
  vunif = rand(1,50) - 0.4 ;
  mdata = [vunif; vunif.^2 - 0.1; 10 * rand(1,50) - 1] ;
...
elseif itest == 30 ;
  ...
  titlecellstr = {{'Test' 'ibigdot = 1' 'see .ps file'}} ;
...
elseif itest == 31 ;
  ...
  titlecellstr = {{'Test' 'ibigdot = 0' 'see .ps file'}} ;
