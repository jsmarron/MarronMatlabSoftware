...
itest = 47 ;    %  1  real data tests (density estimation)
...
elseif itest >= 21 ;    %  then do parameter tests
  ...
  elseif itest == 31 ;
    disp('check output file test1.fig') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'savestr','test1' ...
                                          ) ;
  ...
  elseif itest == 32 ;
    disp('check output file TEMP/test2.fig') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'savestr','TEMP\test2' ...
                                          ) ;
  ...
  elseif itest == 33 ;
    disp('check ndatovlay = 0, so no overlay') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',4, ...
                         'ndatovlay',0 ...
  ...
  elseif itest == 34 ;
    disp('check ndatovlay = 2, full data') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',4, ...
                         'ndatovlay',2 ...
  ...
  elseif itest == 41 ;
    ...
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'famoltitle','Family Overlay, bpar = 0', ...
                         'iout',4, ...
                         'maxx',1.5, ...
                         'bpar',0 ...
                                          ) ;
    ...
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'famoltitle','Family Overlay, bpar = 1', ...
                         'iout',4, ...
                         'maxx',1.5, ...
                         'bpar',1 ...
                                          ) ;
  ...
  elseif itest == 42 ;
    disp('check hhighlight = -1, and others') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',3, ...
                         'maxx',3, ...
  ...
  elseif itest == 44 ;
    disp('check maxx = 3  bpar = 1, iout = 3, viewangle = [195,30]') ;
    paramstruct = struct('iscreenwrite',1,...
                         'maxx',3, ...
                         'iout',3, ...
                         'viewangle',[195,30], ...
  ...
  elseif itest == 47 ;
    disp('check save of movie to .avi file') ;
    paramstruct = struct('iscreenwrite',1,...
                         'savestr','sizerSMtest', ...
                         'imovie',1, ...
                         'iout',3, ... 
  ...
  elseif itest == 48 ;
    disp('check save of .png graphic') ;
    paramstruct = struct('iscreenwrite',1,...
                         'savestr','sizerSMtest', ...
                         'savetype',2, ...
                         'imovie',0, ...
    ...
    sizerSM(data,paramstruct)
    disp(['Now check file sizerSMtest.png']) ;

  elseif itest == 49 ;
    disp('check nfh = 21, fhmin = 0.01, fhmax = 1, nsh = 81, shmin = 0001, shmax = 100') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'maxx',3, ...
  ...
  elseif itest == 52 ;
    disp('check titlefontsize = 18 with more defaults') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',1, ... 
                         'maxx',3, ...
  ...
  elseif itest == 53 ;
    disp('check labelfontsize = 18, iout = 1') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',1, ... 
                         'maxx',3, ...
  ...
  elseif itest == 54 ;
    disp('check iout = 2, nfh = 1, fhmin = 0.08, fhmax = 0.08') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'maxx',3, ...
  ...
  elseif itest == 55 ;
    disp('check iout = 2, nfh = 1, fhmin = 0.008, fhmax = 1') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'maxx',3, ...
  ...
  elseif itest == 56 ;
    disp('check iout = 2, nfh = 10, fhmin = 0.08, fhmax = 0.08') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'maxx',3, ...
  ...
  elseif itest == 57 ;
    disp('check iout = 2, nsh = 1, fhmin = 0.1, fhmax = 0.1') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'maxx',3, ...
  ...
  elseif itest == 58 ;
    disp('check iout = 2, nsh = 1, shmin = 0.1, shmax = 1') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'maxx',3, ...
  ...
  elseif itest == 66 ;
    disp('check Mirror Image Boundary Adjustment') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'minx',0.25, ...
  ...
  elseif itest == 67 ;
    disp('check Circular Design Boundary Adjustment') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',2, ... 
                         'minx',0.25, ...
  ...
  elseif itest == 68 ;
    disp('check manual choice of hhighlight') ;
    paramstruct = struct('iscreenwrite',1,...
                         'imovie',0, ...
                         'iout',4, ... 
                         'minx',0, ...
  ...
  elseif itest == 74 ;
     disp('Check isimflag = 0, Pointwise CI') ;
     paramstruct = struct('iscreenwrite',1,...
                         'simflag', 0,...
                         'imovie',0,...
                         'iout',3, ... 
  ...
  elseif itest == 75 ;
     disp('Check isimflag = 1, Early Row-wise Simultaneous') ;
     paramstruct = struct('iscreenwrite',1,...
                         'simflag', 1,...
                         'imovie',0,...
                         'iout',3, ... 
  ...
  elseif itest == 76 ;
     disp('Check isimflag = 2, Current Row-wise (default) Simultaneous') ;
     paramstruct = struct('iscreenwrite',1,...
                         'simflag',2,...
                         'imovie',0,...
                         'iout',3, ... 
  ...
  elseif itest == 77 ;
     disp('Check isimflag = 3, Early Global Simultaneous') ;
     paramstruct = struct('iscreenwrite',1,...
                         'simflag',3,...
                         'imovie',0,...
                         'iout',3, ... 
  ...
  elseif itest == 78 ;
     disp('Check isimflag = 4, Current Global Simultaneous') ;
     paramstruct = struct('iscreenwrite',1,...
                         'simflag',4,...
                         'imovie',0,...
                         'iout',3, ... 
  ...
  elseif itest == 79 ;
     disp('Check default data overlay') ;
     paramstruct = struct('iscreenwrite',1,...
                         'imovie',0,...
                         'iout',1, ... 
                         'maxx',3, ...
  ...
  elseif itest == 80 ;
     disp('Check overlay of only 100') ;
     paramstruct = struct('iscreenwrite',1,...
                         'imovie',0,...
                         'iout',1, ... 
                         'maxx',3, ...
  ...
  elseif itest == 83 ;
     disp('Check Matlab color overlay') ;
     paramstruct = struct('iscreenwrite',1,...
                         'imovie',0,...
                         'iout',1, ... 
                         'maxx',3, ...
  ...
  elseif itest == 84 ;
     disp('Check rainbow color overlay') ;
     paramstruct = struct('iscreenwrite',1,...
                         'imovie',0,...
                         'iout',1, ... 
                         'maxx',3, ...
